...
export default Route.extend({
  ...
  model (params) {
    ...
    let validTypes = [
      'Web Mapping Application', 'Web Map', 'Dashboard', 'Hub Site Application',
      'Hub Page', 'Hub Initiative', 'Map Service', 'Solution', 'StoryMap',
      'Web Experience', 'Notebook', 'Hub Initiative Template'
    ];
